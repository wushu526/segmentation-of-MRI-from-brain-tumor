...
def parse_args():
    ...
    parser.add_argument('--dataset', default="ShuWu",
                        help='dataset name')
...
def main():
    ...
    # Data loading code
    img_paths = glob(r'/Users/wushu/Project/preprocess/trainImage/*')
    mask_paths = glob(r'/Users/wushu/Project/process/trainMask/*')
